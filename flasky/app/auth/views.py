...
from .forms import LoginForms, RegistrationForms, ChangePasswordForm, PasswordResetRequestForm, PasswordResetForm,ChangeEmailForm 
from .. import db
...
def  password_reset_request():
	...
	if form.validate_on_submit():
		...
		if user:
			...
			send_email(user.email, 'Reset You Password', 'auth/email/reset_password', user=user, token=token, next=request.args.get('next'))
